...
import 'package:pph/helmet_prof.dart';
...
class ProfessionalView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Health Professional",style: TextStyle(color: Colors.white,fontSize:20)),
      ),
      body: 
      SafeArea(child: 
...
CustomScrollView(
        ...
        sliver: SliverGrid.count(
          ...
          child:
           Column(children: <Widget>[
              ...
              //
              const Text('Patient Profile', style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
              //
              IconButton(
          onPressed: (){
            Navigator.push(
    ...
    MaterialPageRoute(builder: (context) => HeadBubble()),
          ...
          onPressed: (){
            Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => HelmetProfessional()),
  );
          },
